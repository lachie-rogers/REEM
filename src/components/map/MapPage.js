...
import CarDetailsPayment from "../car/CarDetailsPayment";
...
class MapPage extends Component {
  ...
  render() {
    ...
    // map styling for window and mobile
    ...
    const showDetails =
      this.state.car != "" ? (
        <div>
          <CarDetailsPayment car={this.state.car} auth={auth} />
    ...
    return (
      <div>
        ...
        <div className="row">
          ...
          <div className="hide-on-small-only col s3" style={{marginBottom: 20}}>
            {showDetails}
          </div>
          ...
          <div className="show-on-small hide-on-med-and-up">
            ...
            >
              ...
              <button onClick={this.handleShowMore} className="white">
                Show more cars
              </button>
            </div>
          </div>
